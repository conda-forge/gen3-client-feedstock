...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gen3-client-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gen3-client-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add gen3-client
# for installing globally
pixi global install gen3-client
```
...
It is possible to list all of the versions of `gen3-client` available on your platform:
...
```
pixi search gen3-client --channel conda-forge
```
